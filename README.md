# Collector for CCVI Datasets
[![Build Status](https://github.com/OCHA-DAP/hdx-scraper-ccvi/actions/workflows/run-python-tests.yaml/badge.svg)](https://github.com/OCHA-DAP/hdx-scraper-ccvi/actions/workflows/run-python-tests.yaml)
[![Coverage Status](https://coveralls.io/repos/github/OCHA-DAP/hdx-scraper-ccvi/badge.svg?branch=main&ts=1)](https://coveralls.io/github/OCHA-DAP/hdx-scraper-ccvi?branch=main)
 ...
 **hdx-scraper-ccvi** as specified in the parameter
 *user_agent_lookup*.
